...
/**
 *   	\file       smartauthdevices_list.php
 *		\ingroup    smartauth
 *		\brief      List page for smartauthdevices
 */
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('smartauth', 'smartauthdevices', 'write');
	$permissiontodelete = $user->hasRight('smartauth', 'smartauthdevices', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'SmartAuthDevices';
	$objectlabel = 'SmartAuthDevices';
...
$title = $langs->trans("SmartAuthDevicess");
//$help_url = "EN:Module_SmartAuthDevices|FR:Module_SmartAuthDevices_FR|ES:Módulo_SmartAuthDevices";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/smartauth/smartauthdevices_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/smartauth/smartauthdevices_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendSmartAuthDevicesRef";
$modelmail = "smartauthdevices";
$objecttmp = new SmartAuthDevices($db);
