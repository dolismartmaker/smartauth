...
class ActionsSmartauth
{
	...
	public function addMoreMassActions($parameters, &$object, &$action, $hookmanager)
	{
		...
		/* print_r($parameters); print_r($object); echo "action: " . $action; */
		if (in_array($parameters['currentcontext'], array('somecontext1', 'somecontext2'))) {		// do something only for the context 'somecontext1' or 'somecontext2'
			$this->resprints = '<option value="0"'.($disabled ? ' disabled="disabled"' : '').'>'.$langs->trans("SmartauthMassAction").'</option>';
		}
	...
	public function printFieldListTitle($parameters, &$object, &$action, $hookmanager)
	{
		...
		// if ($parameters['currentcontext'] == 'smartauthauthlist') {
			// print json_encode($object->fields['appuid']['label']);
			// $object->fields['appuid']['label'] = "Application";
			// $this->resprints = "toto le héro";
	...
	{
		// print json_encode($this->resPrint);
		//print json_encode($object->appuid);

		// global $langs;
		// if ($parameters['currentcontext'] == 'smartauthauthlist') {
		// 	// $object->appuid = 'toto';
		// 	// print '<td class="center">toto';
		// 	// print '</td>';
		// 	$this->resprints = "toto le héro";
		// }
		// return 1;
