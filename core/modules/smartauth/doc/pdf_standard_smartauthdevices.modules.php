...
/**
 *  \file       core/modules/smartauth/doc/pdf_standard.modules.php
 *  \ingroup    smartauth
...
/**
 *	Class to manage PDF template standard_smartauthdevices
 */
class pdf_standard_smartauthdevices extends ModelePDFSmartAuthDevices
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->smartauth->dir_output.'/smartauthdevices') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->smartauth->dir_output.'/smartauthdevices';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->smartauth->dir_output.'/smartauthdevices/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('SMARTAUTH_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('SMARTAUTH_DRAFT_WATERMARK')));
		}
