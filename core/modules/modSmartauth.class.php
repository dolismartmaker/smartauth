...
/**
 * 	\defgroup   smartauth     Module Smartauth
 *  \brief      Smartauth module descriptor.
 *
 *  \file       htdocs/smartauth/core/modules/modSmartauth.class.php
 *  \ingroup    smartauth
...
class modSmartauth extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 471029; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module

		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'smartauth';
		...
		// Module label (no space allowed), used if translation string 'ModuleSmartauthName' not found (Smartauth is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));

		// Module description, used if translation string 'ModuleSmartauthDesc' not found (Smartauth is name of module).
		$this->description = "SmartauthDescription";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "SmartauthDescriptionLong";
		...
		$this->module_parts = array(
			...
			'css' => array(
				//    '/smartauth/css/smartauth.css.php',
			),
			// Set this to relative path of js file if module must load a js on all pages
			'js' => array(
				//   '/smartauth/js/smartauth.js.php',
			),
		...
		// Example: this->dirs = array("/smartauth/temp","/smartauth/subdir");
		$this->dirs = array("/smartauth/temp");

		// Config pages. Put here list of php page, stored into smartauth/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@smartauth");
		...
		//$this->automatic_activation = array('FR'=>'SmartauthWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('SMARTAUTH_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('SMARTAUTH_MYNEWCONST2', 'chaine', 'myvalue', 'This is another constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		if (!isset($conf->smartauth) || !isset($conf->smartauth->enabled)) {
			$conf->smartauth = new stdClass();
			$conf->smartauth->enabled = 0;
		}
		...
		$this->dictionaries=array(
			...
			'tabcond'=>array(isModEnabled('smartauth'), isModEnabled('smartauth'), isModEnabled('smartauth')),
		...
		*/
		...
		// Boxes/Widgets
		// Add here list of php file(s) stored in smartauth/core/boxes that contains a class to show a widget.
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'smartauthwidget1.php@smartauth',
			//      'note' => 'Widget provided by Smartauth',
		...
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'isModEnabled("smartauth")', 'priority'=>50)
		// );
		...
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=tools,fk_leftmenu=smartauth',      // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type' => 'left',                          // This is a Top menu entry
			'titre' => 'SmartAuthPushLogsMenu',
			'prefix' => "",
			'mainmenu' => 'tools',
			'leftmenu' => 'smartauthlogs',
			'url' => '/smartauth/push_logs_list.php',
			'langs' => 'smartauth@smartauth',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position' => 1000 + $r,
			'enabled' => '$conf->smartauth->enabled',  // Define condition to show or hide menu entry. Use '$conf->smartauth->enabled' if entry must be visible if module is enabled.
			'perms' => '$user->rights->smartauth->read',			                // Use 'perms'=>'$user->rights->smartauth->level1->level2' if you want your menu with a permission rules
