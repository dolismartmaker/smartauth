...
/**
 * \file    test/phpunit/SmartauthFunctionalTest.php
 * \ingroup smartauth
...
class SmartauthFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 436132; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modSmartauth')->click();
		} else {
			// Disable the module
			$this->byHref('modSmartauth')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/smartauth/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('smartauth/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/smartauth/admin/about.php');
		$this->authenticate();
		return $this->assertContains('smartauth/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('smartauthwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSmartauth_SmartauthTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSmartauth_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
