...
class RestApiHttpTest extends HttpTestCase
{
    ...
    public function facadeRouteProvider(): array
    {
        ...
        return [
            ...
            // Vague 3 types (same generic routes).
            'GET warehouse'    => ['GET', '/objects/warehouse'],
            'GET member'       => ['GET', '/objects/member'],
            'GET contract'     => ['GET', '/objects/contract'],
            'GET ticket'       => ['GET', '/objects/ticket'],
            'GET intervention' => ['GET', '/objects/intervention'],
            'GET expensereport' => ['GET', '/objects/expensereport'],
            'GET supplier_order'    => ['GET', '/objects/supplier_order'],
            'GET supplier_invoice'  => ['GET', '/objects/supplier_invoice'],
            'GET supplier_proposal' => ['GET', '/objects/supplier_proposal'],
            'GET shipment'       => ['GET', '/objects/shipment'],
            'GET reception'      => ['GET', '/objects/reception'],
            'GET stock_movement' => ['GET', '/objects/stock_movement'],
            'GET subscription'   => ['GET', '/objects/subscription'],
